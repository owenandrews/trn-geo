...
Dataset: list_transport_segments_dorset

	All data is supplied in GDA94 / Map Grid of Australia Zone 55

Clipped Area: Municipality - Dorset

Files Supplied:
	list_transport_segments_dorset.gdb
	municipality_dorset.gdb
	list_transport_segments_dorset.cpg
	list_transport_segments_dorset.DAT
	list_transport_segments_dorset.dbf
	list_transport_segments_dorset.ID
	list_transport_segments_dorset.MAP
	list_transport_segments_dorset.prj
	list_transport_segments_dorset.sbn
	list_transport_segments_dorset.sbx
	list_transport_segments_dorset.shp
	list_transport_segments_dorset.shp.xml
	list_transport_segments_dorset.shx
	list_transport_segments_dorset.tab
	municipality_dorset.cpg
	municipality_dorset.DAT
	municipality_dorset.dbf
	municipality_dorset.ID
	municipality_dorset.MAP
	municipality_dorset.prj
	municipality_dorset.sbn
	municipality_dorset.sbx
	municipality_dorset.shp
	municipality_dorset.shp.xml
	municipality_dorset.shx
	municipality_dorset.tab
	readme.txt
