...
Dataset: list_transport_segments_clarence

	All data is supplied in GDA94 / Map Grid of Australia Zone 55

Clipped Area: Municipality - Clarence

Files Supplied:
	list_transport_segments_clarence.gdb
	municipality_clarence.gdb
	list_transport_segments_clarence.cpg
	list_transport_segments_clarence.DAT
	list_transport_segments_clarence.dbf
	list_transport_segments_clarence.ID
	list_transport_segments_clarence.MAP
	list_transport_segments_clarence.prj
	list_transport_segments_clarence.sbn
	list_transport_segments_clarence.sbx
	list_transport_segments_clarence.shp
	list_transport_segments_clarence.shp.xml
	list_transport_segments_clarence.shx
	list_transport_segments_clarence.tab
	municipality_clarence.cpg
	municipality_clarence.DAT
	municipality_clarence.dbf
	municipality_clarence.ID
	municipality_clarence.MAP
	municipality_clarence.prj
	municipality_clarence.sbn
	municipality_clarence.sbx
	municipality_clarence.shp
	municipality_clarence.shp.xml
	municipality_clarence.shx
	municipality_clarence.tab
	readme.txt
