...
Dataset: list_transport_segments_west_coast

	All data is supplied in GDA94 / Map Grid of Australia Zone 55

Clipped Area: Municipality - West Coast

Files Supplied:
	list_transport_segments_west_coast.gdb
	municipality_west_coast.gdb
	list_transport_segments_west_coast.cpg
	list_transport_segments_west_coast.DAT
	list_transport_segments_west_coast.dbf
	list_transport_segments_west_coast.ID
	list_transport_segments_west_coast.MAP
	list_transport_segments_west_coast.prj
	list_transport_segments_west_coast.sbn
	list_transport_segments_west_coast.sbx
	list_transport_segments_west_coast.shp
	list_transport_segments_west_coast.shp.xml
	list_transport_segments_west_coast.shx
	list_transport_segments_west_coast.tab
	municipality_west_coast.cpg
	municipality_west_coast.DAT
	municipality_west_coast.dbf
	municipality_west_coast.ID
	municipality_west_coast.MAP
	municipality_west_coast.prj
	municipality_west_coast.sbn
	municipality_west_coast.sbx
	municipality_west_coast.shp
	municipality_west_coast.shp.xml
	municipality_west_coast.shx
	municipality_west_coast.tab
	readme.txt
